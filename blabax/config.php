...
$dbss=array();
$dbss['host']='mysql-server';      // Database host (in most cases 'localhost', on Windows systems - use '127.0.0.1' instead of 'localhost' to avoid a php/ipv6 bug)
$dbss['user']='root';      // Database user
$dbss['pass']='secret';      // Database password
$dbss['name']='mychat';      // Database name. Note that the installation script cannot create a database for you!
$dbss['sock']='/var/run/mysqld/mysqld.sock';      // Database socket
